...
export class ValidationManager {
  ...
  async _callSimulateValidation(
    ...
    console.log("errorResult 7373737737373", errorResult);
  ...
  _parseErrorResult(
    ...
    // console.log("ValidationManager 8080808080808080808080");
    if (!errorResult?.errorName?.startsWith("ValidationResult")) {
      // console.log("ValidationManager 8282828282828282");
      ...
      if (paymaster == null) {
        ...
        // console.log("ValidationManager 100100100100100100100");
        throw new RpcError(
    ...
    function fillEntity(
      ...
      // console.log("fill entity addr", addr);
      // console.log(
      //   "fill entity returned value",
      //   addr == null
      //     ? undefined
      //     : {
      //         ...info,
  ...
  async _geth_traceCall_SimulateValidation(
    ...
    // console.log(
    //   "183 _geth_traceCall_SimulateValidation tracerResult",
    //   tracerResult
    // );
  ...
  async validateUserOp(
    ...
    // console.log(
    //   "entered validateUserOp previousCodeHashes",
    //   previousCodeHashes
    // );
    ...
    // console.log("241241241241241241241241241241 this.unsafe", this.unsafe);
